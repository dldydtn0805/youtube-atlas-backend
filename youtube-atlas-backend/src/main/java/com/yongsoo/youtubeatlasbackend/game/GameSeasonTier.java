...
@Entity
@Table(
    name = "game_season_tiers",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_game_season_tiers_season_code", columnNames = {"season_id", "tier_code"}),
        @UniqueConstraint(name = "uk_game_season_tiers_season_order", columnNames = {"season_id", "sort_order"})
    }
)
public class GameSeasonTier {
