...
public class GameCoinTierService {
    ...
    private static final List<DefaultCoinTierDefinition> DEFAULT_TIER_DEFINITIONS = List.of(
        ...
        new DefaultCoinTierDefinition("PLATINUM", "플래티넘", 1_000_000L, "season-platinum", "platinum-investor", "platinum", 4),
        new DefaultCoinTierDefinition("DIAMOND", "다이아몬드", 3_000_000L, "season-diamond", "diamond-investor", "diamond", 5),
        new DefaultCoinTierDefinition("MASTER", "마스터", 10_000_000L, "season-master", "master-investor", "master", 6),
        new DefaultCoinTierDefinition("LEGEND", "레전드", 30_000_000L, "season-legend", "legend-investor", "legend", 7)
    );
