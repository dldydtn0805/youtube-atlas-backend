create table if not exists game_season_results (
    ...
    starting_balance_points bigint not null default 0,
    profit_rate_percent double precision,
    final_highlight_score bigint not null default 0,
    final_tier_code varchar(50),
    final_tier_name varchar(100),
    final_tier_badge_code varchar(100),
    final_tier_title_code varchar(100),
    ...
    best_position_profit_rate_percent double precision,
    best_position_rank_diff integer,
    best_position_buy_rank integer,
    best_position_sell_rank integer,
