...
4. `sql/migrate_game_coin_tier_thresholds.sql` 이 배포 DB에 반영되어 기존 시즌 티어 컷라인이 `BRONZE 0 / SILVER 200,000 / GOLD 1,000,000 / PLATINUM 5,000,000 / DIAMOND 20,000,000` 으로 맞춰졌는지 확인한다.
