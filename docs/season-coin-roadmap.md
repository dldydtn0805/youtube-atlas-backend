...
4. `sql/migrate_game_coin_tier_thresholds.sql`, `sql/migrate_game_coin_add_master_legend_tiers.sql`, `sql/migrate_game_coin_tier_thresholds_20260415.sql`, `sql/migrate_game_coin_tier_thresholds_20260420.sql` 이 배포 DB에 반영되어 시즌 티어 컷라인이 `BRONZE 0 / SILVER 8,000 / GOLD 20,000 / PLATINUM 35,000 / DIAMOND 55,000 / MASTER 85,000 / LEGEND 130,000` 으로 맞춰졌는지 확인한다.
